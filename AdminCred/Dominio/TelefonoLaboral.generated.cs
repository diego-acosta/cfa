...
namespace Dominio	
{
	public partial class TelefonoLaboral
	{
		private int _idTelefonoLaboral;
		public virtual int IdTelefonoLaboral
		{
			get
			{
				return this._idTelefonoLaboral;
			}
			set
			{
				this._idTelefonoLaboral = value;
			}
		}
